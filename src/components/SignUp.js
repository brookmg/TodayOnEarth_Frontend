            ...
            <div style={{ display: 'flex', flexDirection: isDesktopOrLaptop ? 'row' : 'column' }}>
                <div style={{ flex: 1 }}>
                    <Margin horizontal="0.5em" vertical="0.25em">
                        ...
                        <ButtonSignInWith url={`${authEndpoint}/facebook`} borderColor={"#3b5998"} backgroundColor={"#3b5998"} color={"#fff"} imgSrc={`https://upload.wikimedia.org/wikipedia/commons/4/4d/F_icon_reversed.svg`} value="Fill with Facebook" />

                        <ButtonSignInWith url={`${authEndpoint}/google`} borderColor={"#eee"} backgroundColor={"#fff"} color={"#000"} imgSrc={`https://upload.wikimedia.org/wikipedia/commons/5/53/Google_"G"_Logo.svg`} value="Fill with Google" />

                        <ButtonSignInWith url={`${authEndpoint}/github`} borderColor={"#24292e"} backgroundColor={"#fff"} color={"#24292e"} imgSrc={`https://upload.wikimedia.org/wikipedia/commons/9/91/Octicons-mark-github.svg`} value="Fill with GitHub" />

                        <ButtonSignInWith url={`${authEndpoint}/linkedin`} borderColor={"#3577b5"} backgroundColor={"#3577b5"} color={"#fff"} imgSrc={`https://static-exp1.licdn.com/scds/common/u/images/logos/favicons/v1/favicon.ico`} value="Fill with LinkedIn" />
                    </Margin>
                </div>
                <div style={{ flex: 1 }}>
                    <div>
